...
uses KOL, ActiveKOL, Windows, ActiveX;
...
begin
  ...
  // funlang
  PControlData2(ControlData).FirstEventOfs := Cardinal(@@FOnBeforeNavigate) - Cardinal(@Self);
end;
...
begin
  ControlData := @CControlData;
  // funlang
  PControlData2(ControlData).FirstEventOfs := Cardinal(@@FOnStatusTextChange) - Cardinal(@Self);
end;
